...
(define c.jr (make-instruction rs1_n0 (bit-range-fixed 1 0 2) (bit-range-fixed 15 13 4) (bit-range-fixed 12 12 0) (bit-range-fixed 6 2 0)))
(define c.mv (make-instruction rd_n0 c_rs2_n0 (bit-range-fixed 1 0 2) (bit-range-fixed 15 13 4) (bit-range-fixed 12 12 0)))
(define c.ebreak (make-instruction (bit-range-fixed 1 0 2) (bit-range-fixed 15 13 4) (bit-range-fixed 12 12 1) (bit-range-fixed 11 2 0)))
(define c.jalr (make-instruction c_rs1_n0 (bit-range-fixed 1 0 2) (bit-range-fixed 15 13 4) (bit-range-fixed 12 12 1) (bit-range-fixed 6 2 0)))
(define c.add (make-instruction rd_rs1_n0 c_rs2_n0 (bit-range-fixed 1 0 2) (bit-range-fixed 15 13 4) (bit-range-fixed 12 12 1)))
