...
(define aes64ks1i (make-instruction rd rs1 rnum (bit-range-fixed 31 30 0) (bit-range-fixed 29 25 24) (bit-range-fixed 24 24 1) (bit-range-fixed 14 12 1) (bit-range-fixed 6 0 19)))
