...
(define c.lhu (make-instruction rd_p rs1_p c_uimm1 6=0 (bit-range-fixed 1 0 0) (bit-range-fixed 15 13 4) (bit-range-fixed 12 10 1)))
(define c.lh (make-instruction rd_p rs1_p c_uimm1 6=1 (bit-range-fixed 1 0 0) (bit-range-fixed 15 13 4) (bit-range-fixed 12 10 1)))
(define c.sb (make-instruction rs2_p rs1_p c_uimm2 (bit-range-fixed 1 0 0) (bit-range-fixed 15 13 4) (bit-range-fixed 12 10 2)))
(define c.sh (make-instruction rs2_p rs1_p c_uimm1 6=0 (bit-range-fixed 1 0 0) (bit-range-fixed 15 13 4) (bit-range-fixed 12 10 3)))
